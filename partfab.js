...
<div style="position: absolute;  left: 50%;  top: 50%; z-index:15; color:red; transform: translate(-50%, -50%);"><center><h2>Sorry!, you are violating the terms.</h2></center></div>
      ...
      if (!developerName || !developer || !nicknamedev) {
        elemx.remove();
        document.write(`<footer class="pt-5 pb-3"><hr><div class="copyright text-center">
<p>Copyright   <img src="https://mirrors.creativecommons.org/presskit/icons/heart.red.png" width="25" height="25" alt="${nicknamedev}" /> 2023${dd}, Created by <a  href="https://loneeddyservice.blogspot.com/" target="_blank" alt="ดร.วิเชียร พุ่มพวง"> Dr.Wichian Ph. Edit with LoneEddy</a></p></div>
</div>
</footer>`);
      }
if (!fabActive) {
...
$("#fab-active").html(`<div class="fab-container">
      <div class="fab">
        <img src="https://loneeddy.github.io/imglink/loneeddyLogo.png" style="width: 60px;">
      </div>
      ...
      <ul class="fab-options">
        <li>
          ...
          <div class="fab-icon-holder">
            <a target="_blank" href="https://www.facebook.com/Ksm.Mobiles"><i class="fa-brands fa-facebook fs-1 text-primary"></i></i></a>
          </div>
        </li>
        <li>
          <span class="fab-label">ติดต่อเรา</span>
          <div class="fab-icon-holder">
            <a target="_blank" href="https://mail.google.com/mail/u/0/?fs=1&to=ph.loneeddy@gmail.com&tf=cm"><i class="fas fa-envelope fs-2 text-danger"></i></a>
          </div>
        </li>
